...
# srun --pty -p grete -n 1 -C inet -c 80 -G A100:2 /bin/bash
...
python -u multitask_classifier.py --task sst --option finetune --use_gpu --local_files_only --epochs 3 --lr 5e-5 --batch_size 32 --train_mode all_layers --pooling_type None --layers -1
