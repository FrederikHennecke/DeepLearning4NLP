...
python -u multitask_classifier.py --task sts --option finetune --use_gpu --local_files_only --epochs 2
# python -u bart_generation.py --use_gpu --lr 1e-5 --batch_size 64 --epochs 2
